...
class Widget
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Widget", mappedBy="parent", orphanRemoval=true, fetch="EAGER", cascade={"persist", "remove"})
     */
    private $widgets;
     ...
     * Set parent
     *
     * @param \NTR1X\LayoutBundle\Entity\Widget $parent
     *
     * @return Widget
     */
    public function setParent(\NTR1X\LayoutBundle\Entity\Widget $parent = null)
    {
        $this->parent = $parent;
